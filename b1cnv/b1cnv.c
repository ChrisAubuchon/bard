...
void usage(void)
{
	fprintf(stderr, "b1cnv -d inputDir -o outputDir [-acghilms]\n");
...
int main(int argc, char **argv)
{
	...
	xmkdir(bts_sprintf("%s/bt1", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt1/images", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt1/json", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt1/fonts", outputDir->buf));
