...
uint8_t *spellAbbr[] = {
  "MAFL", "ARFI", "TRZP", "FRFO", "MACO", "WOHL", "LERE", "LEVI", "WAST",
  "INWO", "FLRE", "GRRE", "SHSP", "INOG", "MALE", "FLAN", "APAR", "FAFO",
  "INSL", "VOPL", "QUFI", "SCSI", "HOWA", "MAGA", "AREN", "MYSH", "OGST",
  "STFL", "SPTO", "DRBR", "ANMA", "STTO", "PHDO", "YMCA", "REST", "DEST",
  "WZWA", "SASP", "MIJA", "PHBL", "LOTR", "DISB", "WIWA", "FEAR", "WIOG",
  "INVI", "SESI", "CAEY", "WIDR", "DIIL", "MIBL", "WIGI", "SOSI", "WIMA",
  "WIHE", "MAGM", "ZZGO", "SUEL", "FOFO", "GATE", "DEBA", "FLCO", "DISP",
  "PRSU", "ANDE", "SPBI", "SOWH", "GRSU", "BEDE", "WIZW", "HERB", "HAFO",
  "MEME", "BASP", "CAMR", "NILA", "HEAL", "BRKR", "MAMA"
};

uint8_t *spellFull[] = {
  "MAGE FLAME", "ARC FIRE", "TRAP ZAP", "FREEZE FOES", "MAGIC COMPASS",
  "WORD OF HEALING", "LESSER REV.", "LEVITATION", "WARSTRIKE", "INSTANT WOLF",
  "FLESH RESTORE", "GREATER REV.", "SHOCK-SPHERE", "INSTANT OGRE", "MAJOR LEV.",
  "FLESH ANEW", "APPORT ARCANE", "FAR FOE", "INSTANT SLAYER", "VORPAL PLATING",
  "QUICK FIX", "SCRY SITE", "HOLY WATER", "MAGE GAUNTLETS", "AREA ENCHANT",
  "MYSTIC SHIELD", "OGRESTRENGTH", "STARFLARE", "SPECTRE TOUCH", "DRAGON BREATH",
  "ANTI-MAGIC", "STONE TOUCH", "PHASE DOOR", "MYSTICAL ARMOR", "RESTORATION",
  "DEATHSTRIKE", "WIZARD WALL", "SAFETY SPELL", "MIND JAB", "PHASE BLUR",
  "LOCATE TRAPS", "DISBELIEVE", "WIND WARRIOR", "WORD OF FEAR", "WIND OGRE",
  "INVISIBILITY", "SECOND SIGHT", "CAT EYES", "WIND DRAGON", "DISRUPT ILL.",
  "MIND BLADE", "WIND GIANT", "SORCERER SIGHT", "WIND MAGE", "WIND HERO",
  "MAGE MAELSTROM", "DREAMSPELL", "SMN ELEMENTAL", "FORCE FOCUS", "GATE",
  "DEMON BANE", "FLAME COLUMN", "DISPOSSESS", "PRIME SUMMONING", "ANIMATE DEAD",
  "SPELL BIND", "SOUL WHIP", "GREATER SUMMON", "BEYOND DEATH", "WIZARD WAR",
  "SUMMON HERB", "OSCON'S HALTFOE", "MELEE MEN", "BATCHSPELL", "CAMARADERIE",
  "NIGHT LANCE", "HEAL ALL", "BROTHER KRINGLE", "MANGAR'S MALLET"
};
