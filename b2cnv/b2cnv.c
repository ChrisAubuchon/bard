...
void usage(void)
{
	fprintf(stderr, "b2cnv -d inputDir -o outputDir [-acghilms]\n");
...
int main(int argc, char *argv[])
{
	...
	xmkdir(bts_sprintf("%s/bt2", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt2/images", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt2/json", outputDir->buf));
	xmkdir(bts_sprintf("%s/bt2/fonts", outputDir->buf));
